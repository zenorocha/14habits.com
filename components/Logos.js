...
class Logos extends React.Component {
  render() {
    ...
    return <div className="bg-book-gray">
        ...
        <ul className="mx-auto text-center">
          ...
          <li className="mr-8 md:mr-10 lg:mr-20 xl:mr-32 mb-10 inline-block">
            <a target="_blank" href="https://adobe.com">
              <svg className="fill-current text-gray-500 hover:text-book-yellow transition ease-in-out duration-300" height="60" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M315.5 64h170.9v384L315.5 64zm-119 0H25.6v384L196.5 64zM256 206.1L363.5 448h-73l-30.7-76.8h-78.7L256 206.1z" /></svg>
            </a>
          </li>
          <li className="mr-8 md:mr-10 lg:mr-20 xl:mr-32 mb-10 inline-block">
