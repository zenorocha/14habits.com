      ...
      <div className="bg-book-gray">
        ...
        <div className="mt-8 pb-12 bg-white sm:mt-12 sm:pb-16 lg:mt-16 lg:pb-24">
          <div className="relative">
            <div className="absolute inset-0 h-3/4 bg-book-gray"></div>
              ...
              <div className="max-w-md mx-auto space-y-4 lg:max-w-3xl lg:grid lg:grid-cols-2 lg:gap-5 lg:space-y-0">
                <div className="flex flex-col rounded-lg shadow-lg overflow-hidden">
                  <div className="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                    <div>
                      <h3 id="ebook" className="inline-flex px-4 py-1 rounded-full text-sm leading-5 font-semibold tracking-wide uppercase bg-yellow-100 text-yellow-700">
                        E-Book
                      </h3>
                    </div>
                ...
                <div className="flex flex-col rounded-lg shadow-lg relative overflow-hidden">
                  ...
                  <div className="px-6 py-8 bg-white sm:p-10 sm:pb-6">
                    <div>
                      <h3 id="audiobook" className="inline-flex px-4 py-1 rounded-full text-sm leading-5 font-semibold tracking-wide uppercase bg-yellow-100 text-yellow-700">
                        Audiobook
                      </h3>
                    </div>
                    <div className="mt-4 flex items-baseline text-6xl leading-none font-extrabold">
