        ...
        <div className="max-w-screen-xl mx-auto py-3 px-3 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between flex-wrap">
            ...
            <div className="order-2 flex-shrink-0 sm:order-3 sm:ml-3">
              <button onClick={this.hide.bind(this)} type="button" className="-mr-1 flex p-2 rounded-md hover:bg-purple-500 focus:outline-none focus:bg-purple-500 sm:-mr-2 transition ease-in-out duration-300" aria-label="Dismiss">
