      ...
      <div className="bg-gray-900">
        ...
        <div className="mt-16 bg-white pb-12 lg:mt-20 lg:pb-20">
          <div className="relative z-0">
            ...
            <p className="text-center text-base text-gray-700 mt-10">{i18n.t('pricing.moreThan')} <span className="font-semibold">1334 {i18n.t('pricing.copies')}</span> {i18n.t('pricing.sold')}</p>
          </div>
        </div>
      </div>
    </div>
